...
//						System.out.println("\nperson/get_info");
//						for (int i = 0; i < result.getJSONArray("face").length(); ++i)
//							System.out.println(httpRequests.personGetInfo(new PostParameters()
//									.setPersonName("person_" + i)));
//			
//						// -----------------Faceset-----------------
//						// faceset/create
//						System.out.println("\nfaceset/create");
//						for (int i = 0; i < result.getJSONArray("face").length(); ++i)
//							System.out.println(httpRequests.facesetCreate(new PostParameters()
//									.setFacesetName("faceset_" + i)));
//			
//						// faceset/add_face
//						System.out.println("\nfaceset/add_face");
//						for (int i = 0; i < result.getJSONArray("face").length(); ++i)
//							System.out.println(httpRequests.facesetAddFace(new PostParameters().setFacesetName(
...
//						System.out.println("\nfaceset/set_info");
//						for (int i = 0; i < result.getJSONArray("face").length(); ++i) {
//							new PostParameters().setFacesetName("faceset_" + i).setTag("中文 tag_" + i)
//									.getMultiPart().writeTo(System.out);
//							System.out.println(httpRequests.facesetSetInfo(new PostParameters().setFacesetName(
...
//						System.out.println("\nfaceset/get_info");
//						for (int i = 0; i < result.getJSONArray("face").length(); ++i)
//							System.out.println(httpRequests.facesetGetInfo(new PostParameters()
//									.setFacesetName("faceset_" + i)));
//			
//						// -----------------Group-----------------
//						// group/create
...
//			
//						new PostParameters().setGroupName("group_0").setPersonName(personList).getMultiPart()
//								.writeTo(System.out);
//						System.out.println(httpRequests.groupAddPerson(new PostParameters().setGroupName(
//								"group_0").setPersonName(personList)));
//			
//						// group/set_info
//						System.out.println("\ngroup/set_info");
//						System.out.println(httpRequests.groupSetInfo(new PostParameters().setGroupName(
...
//									.getSessionSync(syncRet.get("session_id").toString()));
//						}
//			
...
//						// info/get_face
//						System.out.println("\ninfo/get_app");
//						System.out.println(httpRequests.infoGetFace(new PostParameters().setFaceId(result
...
//						// info/get_image
//						System.out.println("\ninfo/get_image");
//						System.out.println(httpRequests.infoGetImage(new PostParameters().setImgId(result
//								.getString("img_id"))));
//			
...
//						// info/get_session
//						System.out.println("\ninfo/get_session");
//						System.out.println(httpRequests.infoGetSession(new PostParameters().setSessionId(result
//								.getString("session_id"))));
			
						// -----At last----
						// person/remove_face
//						System.out.println("\nperson/remove_face");
//						System.out.println(httpRequests.personRemoveFace(new PostParameters().setPersonName(
//								"person_0").setFaceId(
//								result.getJSONArray("face").getJSONObject(0).getString("face_id"))));
//			
//						// group/delete
